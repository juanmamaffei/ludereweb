...
class MateriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post materia_url, params: { materium: { bibliografia: @materium.bibliografia, descripcion: @materium.descripcion, evaluacion: @materium.evaluacion, nivel: @materium.nivel, nombre: @materium.nombre, objetivos: @materium.objetivos } }
    end
  ...
  test "should update materium" do
    patch materium_url(@materium), params: { materium: { bibliografia: @materium.bibliografia, descripcion: @materium.descripcion, evaluacion: @materium.evaluacion, nivel: @materium.nivel, nombre: @materium.nombre, objetivos: @materium.objetivos } }
